...
export default {
  ...
  created() {
    ...
    this.province_id = this.$route.query.instance.province_id;
    this.city_id = this.$route.query.instance.city_id;
    this.district_id = this.$route.query.instance.district_id;
